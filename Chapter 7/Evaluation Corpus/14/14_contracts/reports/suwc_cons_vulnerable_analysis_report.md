# 🛡️ Sui Move Security Analysis Report: `suwc_cons_vulnerable`
**File:** `./14_contracts/suwc_cons_vulnerable.move`  
...
### 🔴 SUWC-AUTH-01: `batch_distribute`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `batch_distribute`
- **Description:** Privileged function 'batch_distribute' modifies state without capability check
...
### 🟡 SUWC-CONS-02: `batch_distribute`
- **Severity:** MEDIUM
- **Category:** SUWC-CONS
- **Function:** `batch_distribute`
- **Description:** Function 'batch_distribute' has unbounded vector iteration
...
## 🛠️ Tab 4: Fixes
### 💡 Fix: SUWC-AUTH-01
- **Affected functions:** `batch_distribute`
...
**SPARQL Detections:** 2 | **Regex Detections:** 4 | **Total:** 6
