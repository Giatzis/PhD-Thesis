# 🛡️ Sui Move Security Analysis Report: `vuln_access_control`
**File:** `./14_contracts/vuln_access_control.move`  
...
### 🔴 SUWC-AUTH-01: `set_price`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `set_price`
- **Description:** Privileged function 'set_price' modifies state without capability check
...
### 🟠 SUWC-AUTH-04: `set_price`
- **Severity:** HIGH
- **Category:** SUWC-AUTH
- **Function:** `set_price`
- **Description:** Privileged function 'set_price' modifies shared object without authorization
...
### 🔴 SUWC-AUTH-01: `withdraw_funds`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `withdraw_funds`
- **Description:** Privileged function 'withdraw_funds' modifies state without capability check
...
### 🟠 SUWC-AUTH-04: `withdraw_funds`
- **Severity:** HIGH
- **Category:** SUWC-AUTH
- **Function:** `withdraw_funds`
- **Description:** Privileged function 'withdraw_funds' modifies shared object without authorization
...
### 🔴 SUWC-AUTH-01: `toggle_sale`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `toggle_sale`
- **Description:** Privileged function 'toggle_sale' modifies state without capability check
...
### 🟠 SUWC-AUTH-04: `toggle_sale`
- **Severity:** HIGH
- **Category:** SUWC-AUTH
- **Function:** `toggle_sale`
- **Description:** Privileged function 'toggle_sale' modifies shared object without authorization
...
### 🔴 SUWC-AUTH-02: `SaleCap`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `SaleCap`
- **Description:** Capability struct 'SaleCap' has dangerous abilities
...
**Evidence:**
```text
Params: witness: &TOKEN_SALE, ctx: &mut TxContext. Recommended pattern: One-Time Witness (OTW) Pattern
```

### 🟠 SUWC-CONS-01: `TokenSale`
- **Severity:** HIGH
- **Category:** SUWC-CONS
- **Function:** `TokenSale`
- **Description:** Struct TokenSale is missing CircuitBreakerPattern — no pause mechanism or DenyCapV2 field detected
...
### 🔴 SUWC-AUTH-02: `withdraw_funds`
- **Severity:** CRITICAL
- **Category:** SUWC-AUTH
- **Function:** `withdraw_funds`
- **Description:** [SPARQL] withdraw_funds performs Ownership Transfer that indicates SUWC-AUTH-02 risk without mitigation guard
...
## 🛠️ Tab 4: Fixes
### 💡 Fix: SUWC-AUTH-01
- **Affected functions:** `set_price`, `withdraw_funds`, `toggle_sale`
...
### 💡 Fix: SUWC-AUTH-02
- **Affected functions:** `SaleCap`, `init`, `withdraw_funds`
...
**SPARQL Detections:** 2 | **Regex Detections:** 9 | **Total:** 11
...
#### 🔴 SUWC-AUTH-02 — `withdraw_funds`
[SPARQL] withdraw_funds performs Ownership Transfer that indicates SUWC-AUTH-02 risk without mitigation guard
