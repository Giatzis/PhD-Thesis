...
// (Modified for Analyzer Testing - Function names obfuscated)
// Rewritten from secure_vault_all_patterns.move contract
// ============================================================================
...
/// Formerly: create_vault
public fun initialize_secure_storage(ctx: &mut TxContext): (SecureVault, AdminCap, DenyCapV2) {
...
/// Formerly: pause_vault
public fun halt_operations(
    vault: &mut SecureVault,
    cap: &DenyCapV2,
) {
    assert!(object::id(vault) == cap.vault_id, E_NOT_AUTHORIZED);
...
/// Formerly: create_vesting
public fun setup_time_lock(
    vault: &SecureVault,
    cap: &AdminCap,
    clock: &Clock,
    beneficiary: address,
...
/// Formerly: claim_vested
public fun redeem_unlocked_tokens(
    vault: &mut SecureVault,
...
/// Formerly: authorize_upgrade
public fun prepare_contract_migration(
    cap: &mut UpgradeCap,
    policy: u8,
    digest: vector<u8>,
): UpgradeTicket {
...
/// Formerly: commit_upgrade
public fun finalize_contract_migration(
    cap: &mut UpgradeCap,
...
/// Formerly: make_immutable
public entry fun burn_upgrade_rights(cap: UpgradeCap) {
